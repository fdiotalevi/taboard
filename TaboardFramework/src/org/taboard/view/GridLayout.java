...
public class GridLayout extends ViewGroup {
    ...
    public GridLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.org_taboard_GridLayout, defStyle, 0);

        mNumColumns = a.getInt(R.styleable.org_taboard_GridLayout_numColumns, 1);
        mNumRows = a.getInt(R.styleable.org_taboard_GridLayout_numRows, 1);
